...
const exp = [{
        ...
        desp: "<li>I am curently building the community of the zen-z coder's </li> <li> where we do self learning and taking podcast and teaching the peers</li>",
    },

    {
        title: "Executive Member",
        cardImage: "assets/images/experience-page/Unknown-1.png",
        place: "ISTe",
        time: "(May, 2023 - present)",
        desp: "<li>Currently Working as ISTE(Indian Society For Technical Education) executive member.</li> <li>Organize varoius event event around development of community</li> <li>Given Tech talk around Github &</li>",
    },
    {
        title: "CampusLead",
